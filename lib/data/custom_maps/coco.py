...
## Archived Code
# cocoStuff_continuous_35_dict_id_name = {}
# for key, value in cocoStuff_continuous_35_dict.items():
#     if key == 255: continue
#     cocoStuff_continuous_35_dict_id_name[value] = cocoStuff_dict[key]
# print(f"cocoStuff_continuous_53_dict_id_name: {cocoStuff_continuous_35_dict_id_name}")

# cocoStuff_continuous_11_dict_id_name = {}
# for key, value in cocoStuff_continuous_11_dict.items():
#     if key == 255: continue
#     cocoStuff_continuous_11_dict_id_name[value] = cocoStuff_dict[key]
# print(f"cocoStuff_continuous_11_dict_id_name: {cocoStuff_continuous_11_dict_id_name}")

## Output of Archive Code
# cocoStuff_continuous_35_dict_id_name = {0: 'person', 1: 'bicycle', 2: 'car', 3: 'motorcycle', 4: 'bus', 5: 'train', 6: 'truck', 
# 7: 'traffic light', 8: 'fire hydrant', 9: 'stop sign', 10: 'parking meter', 11: 'bench', 12: 'potted plant', 
# 13: 'banner', 14: 'tree', 15: 'house', 16: 'cage', 17: 'cardboard', 18: 'snow', 19: 'fence', 20: 'metal', 
# 21: 'pavement', 22: 'platform', 23: 'playingfield', 24: 'railing', 25: 'railroad', 26: 'road', 27: 'rock', 28: 'roof', 
# 29: 'stairs', 30: 'stone', 31: 'structural-other', 32: 'wall-wood', 33: 'wood'}

# cocoStuff_continuous_11_dict_id_name: {0: 'road', 1: 'pavement', 2: 'house', 3: 'metal', 4: 'traffic light', 
#                                          5: 'stop sign', 6: 'tree', 7: 'snow', 8: 'fence', 9: 'truck'}